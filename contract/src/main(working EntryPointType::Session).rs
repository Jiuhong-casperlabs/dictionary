...
pub const DICTIONARY_REF: &str = "dictionary3";
...
pub extern "C" fn test() {
    ...
    runtime::put_key("sun3", dictionary_uref.into());
    ...
    runtime::put_key("value3", storage::new_uref(value).into());
}
...
pub extern "C" fn call() {
    ...
    runtime::put_key("dictionarycontract3", contract_hash.into());
